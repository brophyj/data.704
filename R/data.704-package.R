#' data.704: Data for EBOH 704
#'
#' Supplies some data sets and functions for 704 labs and lectures.
#'
#' List of datasets included in this package:
#' - [Challeng]: Challenger dataset of O-rings failure
#' - [cannabis]: High school cannabis use
#' - [chic]: Data of Chicago weather
#' - [diabetes]: Diabetes dataset from a cohort study of Pima Indians
