#' Victim dataset from Agresti, A. (2002). Categorical Data Analysis. p. 561
#'
...
#'   \item{race}{Responses by race, for those who identified themselves as black or as white}
#' }
#' @source \url{https://data.library.virginia.edu/getting-started-with-negative-binomial-regression-modeling/}
"victim"
